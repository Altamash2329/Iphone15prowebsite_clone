        ...
        <div className='screen-max-width'>
            ...
            <div className='flex flex-col justify-center items-center overflow-hidden'>
                <div className='mt-32 mb-24 pl-24'>
                    <h2 className='tx-5xl lg:text-7xl font-semibold'>iPhone.</h2>
                    <h2 className='tx-5xl lg:text-7xl font-semibold'>Forged in titanium.</h2>
                </div>
                <div className='flex-center flex-col sm:px-10'>
                    <div className='relative h[-50vh] w-full flex item-center'>
                        <video playsInline id='exploreVideo' className='w-full h-full object-center object-cover' preload='none' muted autoPlay ref={videoRef}>
                            <source src={exploreVideo} type='video/mp4' /></video>
                    </div>
                        ...
                        <div className='feature-text-container'>
                            <div className='flex-1 flex-center'>
                                <p className='feature-text g_text'>iPhone 15 pro is{' '}
                                    ...
                                    using the same alloy that spacecarft use for mission to mars.
                                </p>
                            </div>
                            <div className='flex-1 flex-center'>
                                <p className='feature-text g_text'>Titanium has one of the best strength-to-weight ratios of any metal, making these our{' '}
                                    ...
                                    You'll notice the diffence the moment you pick up one.
                                </p>
                            </div>
                        </div>
                    </div>
